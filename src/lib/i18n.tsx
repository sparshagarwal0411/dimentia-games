...
const en: Dict = {
  ...
  "demo.matchPairs": "Match the pairs! Flip 2 cards",
  "demo.perfectMatch": "🎉 Perfect! All pairs matched! Score: ",
  "demo.pts": "pts",
  "demo.pairs": "pairs",
  "demo.attentionComplete": "Attention Test Complete!",
  "demo.stroopDesc": "Stroop tests cognitive inhibitory control — a key dementia marker.",
  "demo.round": "Round",
  "demo.of": "of",
  "demo.whatColor": "What COLOR is the ink? (ignore the word!)",
  "demo.correct20": "✓ Correct! +20 pts",
  "demo.itWas": "✗ It was",
  "demo.quizDone": "NE Culture Quiz Done!",
  "demo.quizDesc": "Regional memory recall is a core cognitive biomarker.",
  "demo.q": "Q",
  "demo.hear": "Hear",
  "demo.correct25": "✓ Correct! +25 pts",
  "demo.answerIs": "✗ Answer:",
  "demo.noSignIn": "No sign-in needed to explore",
  "demo.startFree": "Start Free Screening →",
...
const hi: Dict = {
  ...
  "demo.matchPairs": "जोड़े मिलाएँ! 2 कार्ड पलटें",
  "demo.perfectMatch": "🎉 उत्तम! सभी जोड़े मिल गए! स्कोर: ",
  "demo.pts": "अंक",
  "demo.pairs": "जोड़े",
  "demo.attentionComplete": "एकाग्रता परीक्षण पूरा हुआ!",
  "demo.stroopDesc": "स्ट्रूप संज्ञानात्मक निरोधात्मक नियंत्रण का परीक्षण करता है - एक प्रमुख डिमेंशिया मार्कर।",
  "demo.round": "दौर",
  "demo.of": "में से",
  "demo.whatColor": "स्याही का रंग क्या है? (शब्द को अनदेखा करें!)",
  "demo.correct20": "✓ सही! +20 अंक",
  "demo.itWas": "✗ यह था",
  "demo.quizDone": "पूर्वोत्तर संस्कृति प्रश्नोत्तरी पूरी हुई!",
  "demo.quizDesc": "क्षेत्रीय स्मृति स्मरण एक प्रमुख संज्ञानात्मक बायोमार्कर है।",
  "demo.q": "प्रश्न",
  "demo.hear": "सुनें",
  "demo.correct25": "✓ सही! +25 अंक",
  "demo.answerIs": "✗ उत्तर:",
  "demo.noSignIn": "खोजने के लिए साइन-इन की आवश्यकता नहीं है",
  "demo.startFree": "मुफ़्त जांच शुरू करें →",
...
const as: Dict = {
  ...
  "demo.matchPairs": "যোৰ মিলাওক! ২খন কাৰ্ড লুটিয়ক",
  "demo.perfectMatch": "🎉 সুন্দৰ! সকলো যোৰ মিলিল! স্ক'ৰ: ",
  "demo.pts": "পইণ্ট",
  "demo.pairs": "যোৰ",
  "demo.attentionComplete": "মনোযোগ পৰীক্ষা সম্পূৰ্ণ!",
  "demo.stroopDesc": "ষ্ট্ৰুপে জ্ঞানীয় প্ৰতিৰোধ নিয়ন্ত্ৰণ পৰীক্ষা কৰে — ডিমেঞ্চিয়াৰ এক প্ৰধান লক্ষণ।",
  "demo.round": "ৰাউণ্ড",
  "demo.of": "ৰ ভিতৰত",
  "demo.whatColor": "চিয়াঁহীৰ ৰং কি? (শব্দটো আওকাণ কৰক!)",
  "demo.correct20": "✓ শুদ্ধ! +২০ পইণ্ট",
  "demo.itWas": "✗ ই আছিল",
  "demo.quizDone": "উত্তৰ-পূব সংস্কৃতিৰ কুইজ সম্পূৰ্ণ!",
  "demo.quizDesc": "আঞ্চলিক স্মৃতি স্মৰণ এক প্ৰধান জ্ঞানীয় লক্ষণ।",
  "demo.q": "প্ৰশ্ন",
  "demo.hear": "শুনক",
  "demo.correct25": "✓ শুদ্ধ! +২৫ পইণ্ট",
  "demo.answerIs": "✗ উত্তৰ:",
  "demo.noSignIn": "চাবলৈ কোনো ছাইন-ইনৰ প্ৰয়োজন নাই",
  "demo.startFree": "বিনামূলীয়া পৰীক্ষা আৰম্ভ কৰক →",

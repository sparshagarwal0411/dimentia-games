/**
 * Gentle Web Audio Synthesizer for tactile feedback.
 * Zero external audio files required — completely offline and lightweight.
 */
...
class SoundSynthesizer {
  ...
  playSuccess() {
    try {
      ...
      // Audio is a subtle enhancement, safe fallback
    }
  }
